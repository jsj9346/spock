# Quant Investment Platform (퀀트 투자 플랫폼)
...
Quant Investment Platform은 체계적인 전략 개발, 백테스팅, 포트폴리오 최적화를 위해 설계된 종합 연구 프레임워크입니다. 자동 매매 실행에서 엄격한 정량적 연구와 증거 기반 의사결정에 초점을 맞춘 플랫폼으로 전환되었습니다.
